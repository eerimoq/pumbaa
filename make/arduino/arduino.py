 ...
 *
 * Do not edit this file. Instead, build and upload this example, start
 * the serial monitor (baudrate 38400) and write your Python code in
 * the interpreter!
 *
 * Enjoy! =)
 */
...
def generate_examples():
    ...
    with open(os.path.join(arduino_example_path, "interactive.ino"), "w") as fout:
