...
static const mp_map_elem_t class_input_locals_dict_table[] = {
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR___exit__), (mp_obj_t)&sys_obj___exit___obj },
};
...
static const mp_map_elem_t class_output_locals_dict_table[] = {
